...
const PILLARS = [
  {
    ...
    text: "In today's world of quick fixes and instant results, the essence of true learning often seems to be fading away. Through Guru Nada, our students will cherish the process and find joy in every small step of improvement.",
  },
  {
    icon: "♪",
    title: "Our Team",
    text: "Guru Nada's team consists of dedicated teachers who share the vision of prioritizing the fundamental work - believing those essential steps are what secure the future of a student's competency.",
  },
  {
    icon: "♫",
    title: "Our Promise",
    text: "Our instructors bring this vision to the comfort of your home. Guru Nada also provides regular monitoring to support each student's challenges and ensure consistent, meaningful progress.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{ fontSize: "2.5rem", marginBottom: "1rem", color: accent }}
          >
            {icon}
          </div>
          <h3
...
function PillarCard({ icon, title, text }) {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "0.9rem", color: "#5a5a4a", lineHeight: 1.75 }}>
        {text}
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <PageHero
        ...
        subtitle="Music is beyond recognizing notes or playing an instrument - it is a heartfelt journey of commitment and dedication that builds invaluable life skills and shapes one's character."
        stats={STATS}
      />
        ...
        >
          ...
          >
            <FlipCard
              ...
              front="Our Mission"
              accent="var(--blush)"
              back="Guru Nada is built on the philosophy that a lasting skill begins with the right foundation. We invite you to begin your musical journey with us, learn with a solid foundation, and discover the true joy of music."
            />
            <FlipCard
              icon="♫"
              front="Our Vision"
              accent="var(--olive)"
              back="Through years of learning and teaching, we believe music shapes one's character and builds invaluable life skills - a heartfelt journey of commitment and dedication that goes far beyond playing an instrument."
            />
          </div>
          <p
            style={{
      ...
      <section
        style={{
          padding: "3rem 0 5rem",
          background:
            "linear-gradient(180deg, var(--cream) 0%, rgba(80,85,60,0.05) 100%)",
        }}
      >
        <div
          style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 1.5rem" }}
