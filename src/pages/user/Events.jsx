    ...
    <div
      ...
      style={{
        ...
        border: ev.highlight
          ...
          : "1px solid rgba(209,167,153,0.2)",
        background: "#fff",
        boxShadow: ev.highlight
          ? "0 8px 32px rgba(39,41,37,0.14)"
          : "0 4px 16px rgba(39,41,37,0.06)",
        ...
        >
          ...
          <div
            style={{
              textAlign: "center",
              fontSize: "0.6rem",
              color: ev.highlight ? "rgba(248,246,237,0.4)" : "#94A3B8",
        ...
        <div style={{ padding: "1.25rem 1.5rem", flex: 1, minWidth: 0 }}>
          ...
          {expanded && (
            ...
            >
              ...
              {/* Tambah setelah tombol Google Calendar, sebelum penutup expanded div */}
              {!past && (
                <Link
  ...
  return (
    ...
    >
      ...
      <PageHero
        ...
        stats={[
          {
            num: upcoming.length > 0 ? String(upcoming.length) : "-",
            label: "Upcoming Events",
          },
          {
            num: past.length > 0 ? String(past.length) : "-",
            label: "Past Events",
          },
        ]}
      />
              ...
              {[1, 2, 3].map((i) => (
                <div
                  ...
                  style={{
                    height: 130,
                    borderRadius: "20px",
                    background: "rgba(209,167,153,0.08)",
                    border: "1px solid rgba(209,167,153,0.15)",
                  }}
                />
              ))}
            </div>
