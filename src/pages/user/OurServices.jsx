    ...
    <div
      ...
      style={{
        ...
        border: lt.highlight
          ...
          : "1px solid rgba(209,167,153,0.3)",
        background: "#fff",
        boxShadow: lt.highlight
          ? "0 12px 40px rgba(39,41,37,0.16)"
          : "0 4px 20px rgba(39,41,37,0.07)",
        display: "flex",
      ...
      {lt.highlight && (
        <div
          style={{
            ...
            overflow: "hidden",
            background:
              "radial-gradient(ellipse 80% 70% at 50% 30%, rgba(209,167,153,0.08) 0%, transparent 70%)",
      ...
      <div
        style={{
          ...
          background: lt.highlight
            ? "linear-gradient(90deg, var(--charcoal) 0%, var(--olive) 100%)"
            : "var(--cream)",
          display: "flex",
          alignItems: "center",
      ...
      >
        <h3
          style={{
            fontSize: "0.95rem",
            fontWeight: 700,
            color: lt.highlight ? "var(--cream)" : "var(--charcoal)",
            margin: 0,
          }}
        >
          {lt.title}
          ...
          >
            <div
              style={{
                ...
                flexShrink: 0,
                background:
                  "linear-gradient(135deg, var(--charcoal), var(--olive))",
                display: "flex",
                alignItems: "center",
...
export default function OurServices() {
                  ...
                  >
                    <span
                      style={{
                        ...
                        fontWeight: 600,
                        color:
                          s.day === "Sunday" ? "#94A3B8" : "var(--charcoal)",
                      }}
                    >
                      {s.day}
                    </span>
                    <span
                      style={{
                        fontSize: "0.85rem",
                        color: s.day === "Sunday" ? "#94A3B8" : "var(--olive)",
                        fontWeight: 500,
                      }}
                    >
                      {s.time}
  ...
  `}</style>
        ...
        >
          {/* Render DUBA KALI untuk seamless loop */}
          {[...INSTRUMENTS, ...INSTRUMENTS].map((inst, i) => (
            ...
            >
              <span style={{ fontSize: "1.2rem", color: "var(--blush)" }}>
                {inst.icon}
              </span>
              {inst.name}
            </div>
