  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: "1rem", color: "var(--blush)" }}>
          {pol.icon}
        </span>
        <h2
          style={{
...
export default function OurPolicy() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollBottom >= document.documentElement.scrollHeight - 120)
    ...
    >
      ...
      >
        <div
          style={{
            height: "100%",
            background: "linear-gradient(90deg, var(--blush), var(--brick))",
      ...
      <section style={{ padding: "4rem 0 2rem" }}>
        ...
        >
          ...
          >
            {POLICIES.map((pol, i) => (
              <PolicyCard key={i} pol={pol} index={i} />
            ))}
          </div>
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                zIndex: 0,
                background:
                  "radial-gradient(ellipse 70% 60% at 80% 20%, rgba(209,167,153,0.1) 0%, transparent 60%)",
            ...
            >
              ...
              >
                ...
                understood all of GuruNada's studio policies and agree to abide
                by them.
              </p>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: canProceed
                      ? "var(--cream)"
                      : "rgba(248,246,237,0.1)",
                    color: canProceed
                      ? "var(--charcoal)"
                      : "rgba(248,246,237,0.2)",
