          ...
          >
            ...
            <div
              style={{
                ...
                height: "50%",
                background:
                  "linear-gradient(to top, rgba(39,41,37,0.5) 0%, transparent 100%)",
              }}
            />
            {/* Instrument badge */}
            <div
            ...
            {(t.tags || []).map((tag) => (
              <span
                ...
                style={{
                  ...
                  fontSize: "10px",
                  fontWeight: 600,
                  background: "rgba(209,167,153,0.12)",
                  color: "var(--blush)",
...
export default function OurTeachers() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ maxWidth: "640px", margin: "0 auto", padding: "0 1.5rem" }}
        >
          <div
            style={{
              width: 40,
